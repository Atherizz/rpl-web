...
<body>
    ...
    <main class="max-w-7xl mx-auto p-4">
        <div class="space-y-2">
            ...
            <img alt="Library with bookshelves and reading area" class="w-full h-auto rounded-lg mb-4 sm:h-[400px] md:h-[420px] object-cover object-center" height="500" src="https://storage.googleapis.com/a1aa/image/eaCe9JWP2lkuSEXemhIXvCAjQ1fRXif09Sc4VqvP4pV8agIfE.jpg" width="600"/>
            <p class="text-bold">
