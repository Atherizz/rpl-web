...
<section class="bg-[#D5D3D3] py-2">
        <div class="container mx-auto ">
            <h2 class="text-2xl font-bold text-gray-700 ml-12">Kontak</h2>
        </div>
</section>
<main class="p-4">
   <div class="flex flex-col md:flex-row justify-center items-start md:items-center space-y-4 md:space-y-0 md:space-x-8">
    ...
    <div class="w-full md:w-1/3 bg-gray-200 p-4 rounded shadow-lg">
     <h2 class="text-center text-xl font-bold mb-4">
      HUBUNGI KAMI
     </h2>
     <div class="space-y-4">
      <div class="flex items-center">
       <i class="fas fa-home text-orange-500 mr-2">
       </i>
       <span>
        Gg. 13 No.50, Dinoyo, Kec. Lowokwaru, Kota Malang, Jawa Timur 65144
       </span>
      </div>
      <div class="flex items-center">
